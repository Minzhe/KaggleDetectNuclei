...
class unet(object):
    ...
    def init_model(self, metrics, learning_rate):
        ...
        up6 = Conv2DTranspose(filters=128, kernel_size=(2,2), strides=(2,2), padding='same') (conv5)
        ...
        up7 = Conv2DTranspose(filters=64, kernel_size=(2,2), strides=(2,2), padding='same') (conv6)
        ...
        up8 = Conv2DTranspose(filters=32, kernel_size=(2,2), strides=(2,2), padding='same') (conv7)
        ...
        up9 = Conv2DTranspose(filters=16, kernel_size=(2,2), strides=(2,2), padding='same') (conv8)
    ...
    def train(self, X_train, y_train, model_name, validation_split=0.2, batch_size=8, epochs=30, verbose=1):
